...
namespace EntityFramework_Slider.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> AddBasket(int? id)  //bize id gelir cartdaki ProductId
        {
            ...
            Product dbProduct = await GetProductById((int)id);   //ve biz  AddBasket methoda gelen Id-li producti databazadan gotururuk.ve-GetProductById((int) id)-idni kast edirik cunku method bizden parametr kimi reqem isteyir ve biz ora sadece id yazsaq string kimi goturur
            ...
            List<BasketVM> basket = GetBasketDatas();   //Coockiden gelen Listi assayn edirik elmizdeki Liste
            ...
            AddProductToBasket(existProduct, dbProduct, basket);    //Ve Listi Add edirik Coockiye
